...
\addtobeamertemplate{headline}{}
{
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \node [anchor=north west, inner sep=3cm, align=center] at ([xshift=-1.25cm,yshift=-2.2cm]current page.north west)
    {\includegraphics[width=2.25cm]{osf-qr.png}\\[2mm]
     \small OSF Preregistration};
\end{tikzpicture}
}
